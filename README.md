...
2. **Run the Program**: Execute the script and provide JSON input of a phishing report.
3. **Review the Output**: The program processes the input and generates a detailed report, which is then copied to the clipboard.
